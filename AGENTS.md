...
Latest unknown-provider refresh: no-storage probes at Taxicab `8cea72c` tested 12 current unknown-host clusters. Chicago recovered 1/5 and Physiology recovered 2/5; Inlibra, Scientific.Net, Persee, PDCNet, ASCE, ActaHort, IWA, Healio, UC Press, and AMPP recovered 0/5 each. Bounded reharvest plus read-only confirmation preserved Chicago 1/5 and Physiology 2/5 durable `good_pdf`. Treat this as +3 bounded cache lift, not accepted full-10K KPI lift, until the next full read-only gate confirms movement.
