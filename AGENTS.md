...
Latest #461 report publish is oxjobs commit `d8948e278`, which records the
JSTOR five-row REVIEW evidence slice as aggregate-only no-movement denominator
...
and records the remaining 3,079 REVIEW rows. CI run `28059614700` passed; the
