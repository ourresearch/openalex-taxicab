...
Latest unknown-tail evidence: no-storage probes at Taxicab `484606b` recovered AJOL 1/3; IET 0/3; SIAM 0/2; JoVE 0/2; AIMS 0/2; and KCI 0/2. Bounded reharvest `pdf-unknown-ajol-reharvest3-484606b` recovered 1/3, and read-only confirmation `pdf-unknown-ajol-readonly3-484606b` preserved 1/3 durable `good_pdf`. Treat AJOL as bounded cache lift and keep the other tail hosts in provider/candidate debt.
