...
`pdf-full10k-after-shop-ibfd-d743417`: 2,407/6,293 `good_pdf` (38.25%), gap
3,572 rows, with two `missing_pdf_harvest -> good_pdf` transitions and zero
...
`residual-clusters-after-shop-ibfd-d743417`, 0-100 anchored bar chart, learning
notes, improvement plan, and next `ser.net.ua` handoff. CI run `27857437910`
