...
(38.57%), gap 3,552 rows, with two `missing_pdf_harvest -> good_pdf`
...
`pdf-full10k-after-revistasunilibre-psmbneos-8dd76b9`, and a 0-100 anchored bar
chart with visual baseline at `0 good_pdf`. The current handoff block above is
authoritative; older PLOS/SCS/Scienceopen queue entries below are historical.
