...
`pdf-full10k-after-plos-fresh-file`: 2,412/6,293 `good_pdf` (38.33%), gap
3,567 rows, with one `corrupt_or_truncated_pdf -> good_pdf` transition and zero
...
`pdf-full10k-after-plos-fresh-file`, and a 0-100 anchored bar chart with visual
baseline at `0 good_pdf`. The current handoff block above is authoritative;
older SCS/Scienceopen queue entries below are historical.
