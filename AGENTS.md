...
Latest #461 report publish is oxjobs commit `5c9c0f275`, which adds
BMC Gastroenterology provider-negative evidence after the post-Wiley public TRUE
small batch. It keeps the 0-origin fixed 0-100 chart, reports draft public TRUE
as 2,458/2,516 (97.69%), and records that BMC Gastroenterology recovered 0/1
with HTML instead of PDF. The current handoff block above is authoritative;
older AJBR/Philology/Revistas/PLOS/SCS/Scienceopen queue entries below are
historical.
