...
Latest #461 report publish is oxjobs commit `5472482dc`, which records the
RSC five-row REVIEW evidence slice as aggregate-only no-movement
...
and records the remaining 3,079 REVIEW rows. CI run `28062872716` passed; the
