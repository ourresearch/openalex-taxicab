...
gate is `pdf-full10k-after-ijltemas-5c76258`: 2,435/6,293
`good_pdf` (38.69%), gap 3,544 rows, with one
`missing_pdf_harvest -> good_pdf` transition and zero good-to-non-good
