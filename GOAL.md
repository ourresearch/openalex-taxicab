...
`batch_e2e_runs/batch-054/rows.csv`. Public oxjobs gets aggregate counts only.
...
After batch 055, update oxjobs #461 with aggregate counts only. Do not publish
