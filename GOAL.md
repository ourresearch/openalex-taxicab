...
Current phase: Gate 21.999al complete; Healio recovered 0/6 PDFs and is recorded in oxjobs at 64517b97. Gate 21.999am, Sage Knowledge bounded sample or provider-guidance test, is next.
...
Gate 21.999am: run Sage Knowledge targeted sample, or test provider guidance for accumulated packets. [next]
...
PDF:
  ...
  next lane: Sage Knowledge bounded sample from latest full gate, or send/test provider packets if Zyte guidance is available
