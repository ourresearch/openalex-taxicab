...
Gate 21.999dr: run current AIP missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 463bb712 #461 taxicab-pdf: publish current JSTOR probe
  ...
  latest provider probe: jstor-current-missing-provider-probe10-fe0d018 at taxicab fe0d018, 0/10 recovered, all best categories html_instead_of_pdf; all PDF-byte strategies returned HTML; oxjobs 463bb712; provider PDF-byte lane, not route-code candidate
