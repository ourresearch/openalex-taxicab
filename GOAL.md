...
Current publish status: oxjobs #461 commit 5abc1635 publishes Nature residual probe `nature-current-missing-provider-probe25-7189521` and Oxford larger probe `oxford-current-missing-provider-probe25-7189521`. Nature recovered 0/15 and Oxford recovered 1/25 only through a `sciengine.com` candidate; `academic.oup.com` recovered 0/23. Keep both in provider/Zyte support, not route-code promotion.
Current phase: Nature and Oxford current-provider probes published after ACM route validation; next lane is provider-support packet refresh or the next current missing-provider cluster while Taxicab main remains gated until full PDF 95% proof. Structured PDF parser is implemented at Taxicab commit a61d34b and oxjobs #461 commit dcb7bb14 publishes the accepted structured-parser full gate. Oxjobs #461 commit 6ba84787 publishes `wiley-residual-corrupt-provider-probe-19-a61d34b`, which recovered 15/19 current residual Wiley corrupt rows without Taxicab POST or production writes. Taxicab commit 3b2d218 routes Wiley `/doi/pdfdirect/` URLs through PDF-byte Zyte HTTP strategies instead of browser HTML. Local no-storage `http_get` validation over the same 19 rows returned 13/19 `good_pdf`; oxjobs #461 commit d4f99eee publishes the candidate evidence. Confirmation-path decision: remote `--reharvest` tests deployed main, while local branch `Harvester` can write production R2/DynamoDB with real env credentials, so do not use local branch writes as a silent confirmation path. Oxjobs #461 commit c15cd194 publishes the follow-up probes and corrected ScienceDirect current-missing probe: Wiley `/doi/pdf/` as-is recovered 0/10, Wiley rewrite-to-`pdfdirect` recovered only 2/10 with one DOI mismatch, Springer `content/pdf` recovered 0/10, and ScienceDirect current missing recovered 0/10 after Taxicab commit 69553ae fixed host-filter normalization. Oxjobs #461 commit d8e62ef8 refreshes the combined Zyte PDF-byte support packet with that evidence. Taxicab commit e584811 classifies publishers from source `PDF URL`/candidate PDF URL fields, reducing accepted full-gate `missing_pdf_harvest` unknown-publisher rows from 966 to 642; oxjobs #461 commit 8b1d1b2f publishes the report slice. Read-only refresh `pdf-full10k-publisher-attribution-e584811` at Taxicab commit 8a35869 is 2,196/6,293 good_pdf (34.90%), with 3,805 missing, 65 corrupt/truncated, 0 timeout, 0 taxicab_error, and a 3,783-row gap to 95%; oxjobs #461 commit ebe97f4d publishes the sanitized report. Current Springer probe `springer-current-missing-provider-probe10-8a35869` at Taxicab commit 8585a77 recovered 0/10, split between 5 interstitial/paywall and 5 unresolved JS; oxjobs #461 commit 84760121 publishes the evidence. Current Wiley probe `wiley-current-missing-provider-probe10-8585a77` at Taxicab commit fa95e59 recovered 0/10, split between 9 unresolved JS and 1 bot block; all 40 strategy attempts stayed HTML, empty, or blocked, and oxjobs #461 commit 3480ae82 publishes the evidence. Current Elsevier probe `elsevier-current-missing-provider-probe10-fa95e59` at Taxicab commit 8abd909 recovered 0/10, split between 7 unresolved JS, 2 HTML-instead-of-PDF, and 1 empty response; oxjobs #461 commit 68c2eb46 publishes the evidence. Current De Gruyter probe `degruyter-current-missing-provider-probe10-eb75f5e` at Taxicab commit eb75f5e recovered 0/10, split between 8 unresolved JS and 2 bot blocks; browser HTML hit captcha for all 10, and PDF-byte header variants returned empty bodies. Oxjobs #461 commit b04396d6 publishes the evidence. Current Lippincott probe `lippincott-current-missing-provider-probe10-eb75f5e` at Taxicab commit 4689af7 recovered 0/10; all 40 strategy attempts were `download_404` against LWW `PageNotFound.aspx` HTML. Oxjobs #461 commit 40cf1b9e publishes the evidence. Current Oxford probe `oxford-current-missing-provider-probe10-4689af7` at Taxicab commit 67187dc recovered 1/10; residuals were 5 bot blocks, 3 HTML-instead-of-PDF, and 1 unresolved JS. Oxjobs #461 commit d4b6da1b publishes the evidence. Current CUP/Cambridge probe `cup-current-missing-provider-probe10-67187dc` at Taxicab commit 41a9df8 recovered 0/10; all 40 strategy attempts were `js_redirect_unresolved`. Oxjobs #461 commit 38844dea publishes the evidence. Current Taylor probe `taylor-current-missing-provider-probe10-70f8f8a` at Taxicab commit 70f8f8a recovered 0/10; best categories were 6 download_404, 3 interstitial/paywall, and 1 empty response. Oxjobs #461 commit af13892d publishes the evidence. Current SSRN probe `ssrn-current-missing-provider-probe10-863d7aa` at Taxicab commit 863d7aa recovered 0/10; all best categories were `js_redirect_unresolved`, and `accept_pdf`/Google-referer returned empty responses. Oxjobs #461 commit 2c171c7e publishes the evidence. Current JSTOR probe `jstor-current-missing-provider-probe10-fe0d018` at Taxicab commit fe0d018 recovered 0/10; all best categories were `html_instead_of_pdf`, and all PDF-byte strategies returned HTML. Oxjobs #461 commit 463bb712 publishes the evidence. Current AIP Publishing probe `aip-publishing-current-missing-provider-probe10-af746d4` at Taxicab commit af746d4 recovered 0/10; best categories were 6 JS redirects, 3 interstitial/paywall, and 1 HTML-instead-of-PDF. Oxjobs #461 commit 14f254ac publishes the evidence. Current RSC probe `rsc-current-missing-provider-probe10-f709792` at Taxicab commit f709792 recovered 1/10; larger confirmation `rsc-current-missing-provider-probe25-05b1a38` at Taxicab commit 05b1a38 recovered 0/25, with best categories 24 JS redirects and 1 HTML-instead-of-PDF. Oxjobs #461 commit 84f1c8ea publishes the larger confirmation evidence. Current ACS probe `acs-current-missing-provider-probe10-7e4b5e5` at Taxicab commit 7e4b5e5 recovered 0/10; all best categories were JS redirects. Oxjobs #461 commit 21a7697c publishes the evidence. Current Brill probe `brill-current-missing-provider-probe10-88bc77f` at Taxicab commit 88bc77f recovered 0/10; all best categories and all 40 strategy attempts were bot blocks. Oxjobs #461 commit e2bac29b publishes the evidence. Current Thieme probe `thieme-current-missing-provider-probe10-3f45c6a` at Taxicab commit 3f45c6a recovered 0/10; all best categories and all 40 strategy attempts were unresolved JS. Oxjobs #461 commit 4838bd1c publishes the evidence. Current SPIE probe `spie-current-missing-provider-probe10-9fa4596` at Taxicab commit 9fa4596 recovered 0/10; all best categories and all 40 strategy attempts were unresolved JS. Oxjobs #461 commit fe048cca publishes the evidence. Current BMJ probe `bmj-current-missing-provider-probe10-9ccfeaf` at Taxicab commit 9ccfeaf recovered 2/10; residual best categories were 6 bot blocks and 2 interstitial/paywall rows. Oxjobs #461 commit 6de28ec3 publishes the evidence. Current Sage probe `sage-current-missing-provider-probe10-1f57c9b` at Taxicab commit 1f57c9b recovered 0/10; best categories were 6 bot blocks and 4 unresolved JS rows. Oxjobs #461 commit d059488d publishes the evidence. Current AMA/JAMA probe `ama-current-missing-provider-probe10-2198bc2` at Taxicab commit 2198bc2 recovered 0/10; best categories were 5 interstitial/paywall, 4 unresolved JS, and 1 bot block. Oxjobs #461 commit eddf9c5a publishes the evidence. Current Karger probe `karger-current-missing-provider-probe10-4427b24` at Taxicab commit 4427b24 recovered 0/10; every best category was HTML-instead-of-PDF. Oxjobs #461 commit 69b2780a publishes the evidence. Current APS probe `aps-current-missing-provider-probe10-cf3d845` at Taxicab commit cf3d845 recovered 1/10 through google_referer; residual best categories were 9 unresolved JS rows. Oxjobs #461 commit 5da73adb publishes the evidence. Current ACM probe `acm-current-missing-provider-probe10-dba7e2f` first recovered 1/10 through default_body/google_referer. Larger confirmation `acm-current-missing-provider-probe25-26f35ea` at Taxicab commit 26f35ea recovered 6/22 through default_body/google_referer; residual best categories were 12 HTML-instead-of-PDF, 3 unresolved JS, and 1 empty_response. Oxjobs #461 commit 88b3d53f publishes the evidence and makes ACM a narrow route-strategy candidate. Current Optica probe `optica-current-missing-provider-probe10-1b0823d` at Taxicab commit 1b0823d recovered 0/10; best categories were 8 unresolved JS and 2 HTML-instead-of-PDF, with browser HTML returning 8 interstitial/paywall rows. Oxjobs #461 commit f57bad44 publishes the evidence. Current IOP probe `iop-current-missing-provider-probe10-8aaf717` at Taxicab commit 8aaf717 recovered 6/10 current missing rows as good_pdf through PDF-byte strategies; residual best categories were 2 bot_block_403 and 2 interstitial_or_paywall. Oxjobs #461 commit bd7396fb publishes the evidence. All-current IOP confirmation `iop-current-missing-provider-probe25-ad609f7` at Taxicab commit ad609f7 recovered 9/18 current IOP missing rows as good_pdf; residual best categories were 6 bot_block_403, 2 interstitial_or_paywall, and 1 html_instead_of_pdf. Oxjobs #461 commit 51b4665a publishes the evidence and confirms a narrow branch-only IOP article-PDF route candidate. Treat Springer, current Wiley, current Elsevier, current De Gruyter, current Lippincott, current Oxford, current CUP/Cambridge, current Taylor, current SSRN, current JSTOR, current AIP Publishing, current RSC, current ACS, current Brill, current Thieme, current SPIE, current BMJ, current Sage, current AMA/JAMA, current Karger, current APS, current ACM residual, and current Optica residual missing clusters as provider/Zyte PDF-byte, click-download, bot-block, JS/access-flow, or candidate-discovery debt, not route-code candidates. Current IOP is a confirmed narrow branch-only IOP article-PDF route candidate. Current ACM has a confirmed narrow branch-only ACM `/doi/pdf/` PDF-byte route candidate from 6/22 current missing-row recovery; local branch route validation `acm-http-get-local-route-precommit-1950532` returned 5/22 classifier good_pdf, with 4/22 clean URL-match recoveries and one candidate-DOI mismatch; residual ACM rows remain provider/Zyte support debt. Taxicab commit 07c8f95 implements only `iopscience.iop.org/article/.../pdf` PDF-byte routing with request timeouts and does not broaden to IOP book/chapter PDF paths; local no-storage branch `http_get` validation `iop-http-get-local-route-precommit` returned 11/16 good_pdf and 5 bot_block_403, with no Taxicab POST/R2/DynamoDB writes. Oxjobs #461 commit c3c9b0ac publishes the IOP route validation. Oxjobs #461 commit 695fb51d publishes the ACM route validation. BMJ larger confirmation `bmj-current-missing-provider-probe25-622512f` recovered only 1/25 and oxjobs #461 commit e5b648f6 publishes it. RSC larger confirmation `rsc-current-missing-provider-probe25-05b1a38` recovered 0/25 and oxjobs #461 commit 84f1c8ea publishes it. APS larger confirmation `aps-current-missing-provider-probe25-576c058` recovered 0/24 at Taxicab commit 576c058 and oxjobs #461 commit 5435e2c7 publishes it. ACM larger confirmation `acm-current-missing-provider-probe25-26f35ea` recovered 6/22 at Taxicab commit 26f35ea and oxjobs #461 commit 88b3d53f publishes it. ACM route regression checks, branch commit/push, and oxjobs #461 publication are complete. Next lane is provider-support packet refresh or the next current missing-provider cluster; do not push Taxicab main before the full PDF 95% proof.
Next exact command:
cd /Users/shubh-trips/Documents/OpenAlex/openalex-taxicab && python3 scripts/secret_scan.py && git diff --check -- AGENTS.md CLAUDE.md GOAL.md NEXT_TO_DO.md && python3 -m unittest discover -s tests && python3 scripts/taxicab_pdf_eval.py --fixture-smoke --out /tmp/taxicab-pdf-fixture-smoke-nature-oxford-sync --run-id pdf-fixture-smoke-nature-oxford-sync
```
...
PDF:
  ...
  latest implementation candidates: 3b2d218 taxicab: fetch Wiley pdfdirect as PDF bytes; 07c8f95 taxicab: fetch IOP article PDFs as bytes; Taxicab commit 39fa9c2 ACM /doi/pdf byte route implemented on branch
  local candidate validation: Wiley 13/19 current residual rows classified good_pdf through local http_get; IOP article-PDF route validation `iop-http-get-local-route-precommit` returned 11/16 good_pdf and 5 bot_block_403; ACM route validation `acm-http-get-local-route-precommit-1950532` returned 5/22 classifier good_pdf, 4/22 strict URL-match recoveries, one candidate-DOI mismatch, and no Taxicab POST/R2/DynamoDB writes
  latest oxjobs publication: 695fb51d #461 taxicab-pdf: publish ACM route validation
  ...
  current read-only refresh: pdf-full10k-publisher-attribution-e584811 at taxicab 8a35869, 2,196/6,293 good_pdf (34.90%), +3 current read-only movement, 3,805 missing_pdf_harvest, 65 corrupt_or_truncated_pdf, 0 timeout, 0 taxicab_error, 3,783-row gap to 95%; not production scraping-code lift
  latest provider probe: iop-current-missing-provider-probe25-ad609f7 at taxicab ad609f7, 9/18 recovered as good_pdf; residual best categories 6 bot_block_403, 2 interstitial_or_paywall, 1 html_instead_of_pdf; oxjobs 51b4665a; confirmed narrow branch-only IOP article-PDF route candidate; route implemented at taxicab 07c8f95 and local branch validation recovered 11/16 article-path candidates
  no_pdf_expected: 3,707
  denominator-enriched gap to 95%: 3,783 rows on current refresh
  dominant category: 3,805 missing_pdf_harvest
