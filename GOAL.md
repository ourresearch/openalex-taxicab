...
Gate 21.999do: run current Taylor missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 38844dea #461 taxicab-pdf: publish current CUP probe
  ...
  latest provider probe: cup-current-missing-provider-probe10-67187dc at taxicab 41a9df8, 0/10 recovered, all 40 strategy attempts js_redirect_unresolved; oxjobs 38844dea; provider/support lane, not route-code candidate
