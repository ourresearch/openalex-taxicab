...
Current publish status: oxjobs #461 commit `5472482dc` records the RSC five-row
REVIEW evidence slice as aggregate-only no-movement denominator
...
Oxjobs CI run `28062872716` passed; the live raw report and new aggregate
