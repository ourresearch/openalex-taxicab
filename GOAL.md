...
Current publish status: oxjobs #461 commit `086f1aa8d` publishes the Wiley
provider/production mismatch packet after the accepted one-row cache gate, the
fixed 0-origin 0-100 chart, and the updated denominator audit. GitHub `main`,
oxjobs CI, and the live oxjobs.org raw report route are verified. Draft public
TRUE is 2,458/2,516 (97.69%) but remains provisional until the 3,804 REVIEW rows
are resolved.
