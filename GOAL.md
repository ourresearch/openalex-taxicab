...
Gate 21.999dv: run current Thieme missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: e2bac29b #461 taxicab-pdf: publish current Brill probe
  ...
  latest provider probe: brill-current-missing-provider-probe10-88bc77f at taxicab 88bc77f, 0/10 recovered, all best categories and all 40 strategy rows bot_block_403; oxjobs e2bac29b; provider/Zyte bot-block lane, not route-code candidate
