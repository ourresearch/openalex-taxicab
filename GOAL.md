...
Gate 21.999ds: run current RSC missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 14f254ac #461 taxicab-pdf: publish current AIP probe
  ...
  latest provider probe: aip-publishing-current-missing-provider-probe10-af746d4 at taxicab af746d4, 0/10 recovered, best categories 6 js_redirect_unresolved, 3 interstitial_or_paywall, and 1 html_instead_of_pdf; oxjobs 14f254ac; provider/access-flow lane, not route-code candidate
