...
Review-pack aggregate: <code>missing_pdf_harvest=246</code>, <code>html_instead_of_pdf=2</code>, <code>js_redirect_unresolved=1</code>, <code>bot_block_403=1</code>. Note classes in the pack are <code>goldie_content_approved_not_pdf_availability=133</code>, <code>no_existing_note=88</code>, <code>parseland_extraction_miss=14</code>, <code>needs_live_fetch=5</code>, <code>taxicab_html_harvest_missing=5</code>, <code>taxicab_download_error=4</code>, and <code>bot_check=1</code>. Top sampled hosts include <code>link.springer.com</code>, <code>onlinelibrary.wiley.com</code>, <code>degruyterbrill.com</code>, <code>journals.lww.com</code>, <code>sciencedirect.com</code>, <code>cambridge.org</code>, <code>academic.oup.com</code>, <code>papers.ssrn.com</code>, <code>jstor.org</code>, <code>api.taylorfrancis.com</code>, <code>opg.optica.org</code>, <code>brill.com</code>, <code>journals.uchicago.edu</code>, and <code>journals.sagepub.com</code>.
...
Latest positive REVIEW evidence slice: private no-storage Zyte run <code>acs-review-pack-provider5-278f867</code> sampled <code>5</code> <code>pubs.acs.org</code> rows from the private top-250 REVIEW pack. It recovered <code>2/5</code> valid PDFs; residual best category was <code>js_redirect_unresolved=3</code>. Private overlay would move <code>2</code> rows from public REVIEW to TRUE and all-known REVIEW to TRUE; the other <code>3</code> rows stay REVIEW. Public aggregate asset <code>evidence/report461-acs-review-provider-overlay-summary-278f867.json</code> is published in oxjobs #461 at commit <code>3f1a347e4</code>, and the live raw report/asset were verified after cache retry.

Prior no-movement REVIEW evidence slice: private no-storage Zyte run <code>degruyter-review-pack-provider5-3aad3d4</code> sampled <code>5</code> <code>degruyterbrill.com</code> rows from the private top-250 REVIEW pack. It recovered <code>0/5</code> valid PDFs; best category was <code>js_redirect_unresolved=5</code>. Private overlay joined all five rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-degruyter-review-provider-overlay-summary-3aad3d4.json</code> is published in oxjobs #461 at commit <code>9f6e08ec6</code>, and the live raw report/asset were verified after cache retry.

Prior no-movement REVIEW evidence slice: private no-storage Zyte run <code>lww-review-pack-provider5-c14dd0c</code> sampled <code>5</code> <code>journals.lww.com</code> rows from the private top-250 REVIEW pack. It recovered <code>0/5</code> valid PDFs; best category was <code>js_redirect_unresolved=5</code>, with PDF-byte strategies mostly returning <code>bot_block_403</code>. Private overlay joined all five rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-lww-review-provider-overlay-summary-c14dd0c.json</code> is published in oxjobs #461 at commit <code>56010bb68</code>, and the live raw report/asset were verified after cache retry.

Prior no-movement REVIEW evidence slice: private no-storage Zyte run <code>spie-review-pack-provider5-b1c0a0b</code> sampled <code>5</code> <code>spiedigitallibrary.org</code> rows from the private top-250 REVIEW pack. It recovered <code>0/5</code> valid PDFs; best categories were <code>empty_response=3</code> and <code>js_redirect_unresolved=2</code>. Private overlay joined all five rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-spie-review-provider-overlay-summary-b1c0a0b.json</code> is published in oxjobs #461 at commit <code>b8005f79f</code>, and the live raw report/asset were verified after cache retry.

Prior no-movement REVIEW evidence slice: private no-storage Zyte run <code>thieme-review-pack-provider5-e82a0e3</code> sampled <code>5</code> <code>thieme-connect.de</code> rows from the private top-250 REVIEW pack. It recovered <code>0/5</code> valid PDFs; best categories were <code>js_redirect_unresolved=4</code> and <code>download_404=1</code>. Private overlay joined all five rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-thieme-review-provider-overlay-summary-e82a0e3.json</code> is published in oxjobs #461 at commit <code>097611d87</code>, and the live raw report/asset were verified after cache retry.
...
Latest no-movement REVIEW evidence slice: private no-storage Zyte run <code>aps-review-pack-provider5-42515c1</code> sampled <code>5</code> <code>link.aps.org</code> rows from the private top-250 REVIEW pack. It recovered <code>0/5</code> valid PDFs; best categories were <code>js_redirect_unresolved=4</code> and <code>html_instead_of_pdf=1</code>. Private overlay joined all five rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-aps-review-provider-overlay-summary-42515c1.json</code> is published in oxjobs #461 at commit <code>ff3d15e72</code>; CI run <code>28065330101</code> passed and the live raw report/asset were verified after cache retry. Accepted sidecar counts are unchanged.

Latest resolver REVIEW evidence slice: private no-storage Zyte run <code>doi-review-pack-provider5-5ead190</code> sampled <code>2</code> <code>doi.org</code> rows from the private top-250 REVIEW pack after probe-script filtering. It recovered <code>0/2</code> valid PDFs; best categories were <code>download_404=1</code> and <code>html_instead_of_pdf=1</code>. Private overlay joined both rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-doi-review-provider-overlay-summary-5ead190.json</code> is published in oxjobs #461 at commit <code>8cc23feff</code>; CI run <code>28065750094</code> passed and the live raw report/asset were verified after cache retry. Accepted sidecar counts are unchanged.

Latest Optica REVIEW evidence slice: private no-storage Zyte run <code>optica-review-pack-provider5-74d0350</code> sampled <code>5</code> <code>opg.optica.org</code> rows from the private top-250 REVIEW pack. It recovered valid PDF bytes for <code>1/5</code> rows; residual best categories were <code>js_redirect_unresolved=3</code> and <code>html_instead_of_pdf=1</code>. Private overlay would move <code>1</code> row from REVIEW to public TRUE/all-known TRUE; the other <code>4</code> rows stay REVIEW. Public aggregate asset <code>evidence/report461-optica-review-provider-overlay-summary-74d0350.json</code> is published in oxjobs #461 at commit <code>0579d009e</code>; CI run <code>28066207670</code> passed and the live raw report/asset were verified after cache retry. Accepted sidecar counts are unchanged until the private overlay is reviewed and adopted.

Latest Brill REVIEW evidence slice: private exact-host no-storage Zyte run <code>brill-review-pack-provider5-22bd2cb</code> sampled <code>5</code> <code>brill.com</code> rows from the private top-250 REVIEW pack. It recovered <code>0/5</code> valid PDFs; every strategy classified all rows as <code>bot_block_403</code>. Private overlay joined all five rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-brill-review-provider-overlay-summary-22bd2cb.json</code> is published in oxjobs #461 at commit <code>e57048cbb</code>; CI run <code>28066737081</code> passed and the live raw report/asset were verified after cache retry. Accepted sidecar counts are unchanged. Use exact-host private CSV filtering for overlapping host strings such as <code>brill.com</code> versus <code>degruyterbrill.com</code>.

Latest positive UChicago REVIEW evidence slice: private exact-host no-storage Zyte run <code>uchicago-review-pack-provider5-65ef934</code> sampled <code>5</code> <code>journals.uchicago.edu</code> rows from the private top-250 REVIEW pack. It recovered valid PDF bytes for <code>1/5</code> rows; residual best category was <code>js_redirect_unresolved=4</code>. Private overlay would move <code>1</code> row from REVIEW to public TRUE/all-known TRUE; the other <code>4</code> rows stay REVIEW. Public aggregate asset <code>evidence/report461-uchicago-review-provider-overlay-summary-65ef934.json</code> is published in oxjobs #461 at commit <code>85a187f4a</code>; CI run <code>28067378187</code> passed and the live raw report/asset were verified after cache retry. Accepted sidecar counts are unchanged until the private overlay is reviewed and adopted.

Latest SAGE REVIEW evidence slice: private exact-host no-storage Zyte run <code>sagepub-review-pack-provider5-f0f4d01</code> sampled <code>5</code> <code>journals.sagepub.com</code> rows from the private top-250 REVIEW pack. It recovered <code>0/5</code> valid PDFs; best categories were <code>js_redirect_unresolved=4</code> and <code>empty_response=1</code>. Private overlay joined all five rows but made <code>0</code> status or denominator changes, so these rows stay REVIEW. Public aggregate asset <code>evidence/report461-sagepub-review-provider-overlay-summary-f0f4d01.json</code> is published in oxjobs #461 at commit <code>291cef372</code>; CI run <code>28067967181</code> passed and the live raw report/asset were verified after cache retry. Accepted sidecar counts are unchanged.
...
python3 scripts/provider_pdf_probe.py \
  --input /Users/shubh-trips/Documents/OpenAlex/parseland-eval/eval/data/merged-FINAL-pdf-review-pack-top250.csv \
  --category '' \
  --host <next-review-pack-host> \
  --limit 5 \
  --strategies all \
  --out /tmp/taxicab-pdf-review-provider-probes \
  --run-id <host>-review-pack-provider5-<taxicab-sha> \
  --env-file .env \
  --timeout 45 \
  --sleep 0.5
```

After the provider run, use the overlay command above, inspect aggregate transitions, and publish only aggregate summaries. Keep raw DOI rows, raw URLs, Browserbase JSON, session IDs, screenshots, signed URLs, and HTML out of public artifacts. Verification before any Taxicab commit remains <code>python3 -m unittest discover -s tests</code>, PDF fixture smoke, <code>git diff --check</code>, and tracked-file secret scan.
...
Current publish status: oxjobs #461 commit `ea0efc9d7` records the AIP five-row
REVIEW evidence slice as aggregate-only denominator-exclusion
evidence. The report keeps the Cambridge full gate as the accepted metric, keeps
the fixed 0-origin 0-100 chart, and publishes the updated denominator audit.
Oxjobs CI run `28064524208` passed; the live raw report and new aggregate
...
`good_pdf` (39.15%), +1 versus the prior accepted gate and +627 versus the
first measured denominator reference, with 0 timeout and 0 `taxicab_error`.
This is a bounded cache/reharvest lift plus clean read-only measurement, not a
Taxicab-main production scraping push. Current phase is shifting to denominator
REVIEW reduction or provider-support packets rather than more blind tail probing.
Do not
...
accepted metric is `taxicab-pdf-after-cambridge-cache-6386430`,
2,464/6,293 `good_pdf` (39.15%), with a 3,515-row gap to 95% on the legacy raw
denominator. The current handoff block above is authoritative; older entries
...
AAAS Science.org gold check at Taxicab branch commit `53d3704` recovers 0/1
...
`a25417e` recovers 0/2 through Zyte no-storage strategies and 0/2 through
...
Gate 21.999fz: add Zyte browser network-capture decoding to provider probes. [done, taxicab 56d2c2c, unit/fixture gates passed, no production behavior change]
Gate 21.999ga: test Springer network-capture recipe on a bounded no-storage sample. [done, springer-network-capture-probe3b-56d2c2c recovered 0/3; 2 target-site 429, 1 unresolved JS redirect; provider/support evidence only]
Gate 21.999gb: test De Gruyter Brill token network-capture recipe on a bounded no-storage sample. [done, degruyter-network-capture-probe3-d178c76 recovered 0/3; all 3 returned 405 captcha HTML; provider/support evidence only]
Gate 21.999gc: test Lippincott/LWW token network-capture recipe on a bounded no-storage sample. [done, lippincott-network-capture-probe3-84b519f recovered 0/3; 2 js_redirect_unresolved, 1 bot_block_403; provider/support evidence only]
Gate 21.999gd: test Oxford Academic token network-capture recipe on a bounded no-storage sample. [done, oxford-network-capture-probe3-bea12c4 recovered 0/3; 2 html_instead_of_pdf PDF-viewer/html shells, 1 bot_block_403; provider/support evidence only]
Gate 21.999ge: test SSRN token network-capture recipe on a bounded no-storage sample. [done, ssrn-network-capture-probe3-03cffc3 recovered 0/3; all 3 returned image/svg+xml corrupt_or_truncated_pdf payloads; provider/support evidence only]
Gate 21.999gf: refresh private provider packet and publish aggregate NetworkCapture support addendum. [done, oxjobs cdc23cfc7; five-lane sweep 0/15]
Gate 21.999gg: test AIP Publishing token network-capture recipe on a bounded no-storage sample. [done, aip-pubs-network-capture-probe3-next recovered 0/3; 2 bot_block_403, 1 html_instead_of_pdf PDF-viewer/html shell; provider/support evidence only]
...
PDF:
  ...
  latest provider probe: oxford-network-capture-probe3-bea12c4 at taxicab bea12c4 tested Zyte browser networkCapture with a broad pdf token against 3 current Oxford Academic academic.oup.com rows; recovered 0/3 good_pdf, with 2 html_instead_of_pdf PDF-viewer/html shells and 1 bot_block_403; provider/support evidence only
  latest provider probe: ssrn-network-capture-probe3-03cffc3 at taxicab 03cffc3 tested Zyte browser networkCapture with a broad pdf token against 3 current SSRN papers.ssrn.com rows; recovered 0/3 good_pdf, all with 200 image/svg+xml payloads classified corrupt_or_truncated_pdf; provider/support evidence only
