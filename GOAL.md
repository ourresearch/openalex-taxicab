...
Gate 21.999dd: refresh combined Zyte PDF-byte support packet with current follow-up evidence. [next]
...
PDF:
  ...
  latest oxjobs publication: c15cd194 #461 taxicab-pdf: publish ScienceDirect current probe
  latest follow-up probes: Wiley /doi/pdf as-is 0/10; Wiley rewrite-to-pdfdirect 2/10 with one DOI mismatch; Springer content/pdf 0/10; ScienceDirect current missing 0/10 after host-filter normalization
  current code slice: provider probe summary ranking fix plus host-filter normalization, measurement/reporting-only
