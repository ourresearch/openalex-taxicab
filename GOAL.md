...
Gate 21.999dx: run current BMJ missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: fe048cca #461 taxicab-pdf: publish current SPIE probe
  ...
  latest provider probe: spie-current-missing-provider-probe10-9fa4596 at taxicab 9fa4596, 0/10 recovered, all best categories and all 40 strategy rows js_redirect_unresolved; oxjobs fe048cca; provider/Zyte JS-access-flow lane, not route-code candidate
