...
Gate 21.999dk: run current De Gruyter missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 68c2eb46 #461 taxicab-pdf: publish current Elsevier probe
  ...
  latest provider probe: elsevier-current-missing-provider-probe10-fa95e59 at taxicab 8abd909, 0/10 recovered, 7 js_redirect_unresolved, 2 html_instead_of_pdf, and 1 empty_response; oxjobs 68c2eb46; not route-code candidate
