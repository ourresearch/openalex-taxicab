...
Gate 21.999ed: run current Optica missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 88c2fddb #461 taxicab-pdf: publish current ACM probe
  ...
  latest provider probe: aps-current-missing-provider-probe10-cf3d845 at taxicab cf3d845, 1/10 recovered through google_referer, residual best categories 9 js_redirect_unresolved; oxjobs 5da73adb; partial provider-strategy evidence, not route-code candidate yet
