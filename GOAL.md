...
Gate 21.999dn: run current CUP/Cambridge missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: d4b6da1b #461 taxicab-pdf: publish current Oxford probe
  ...
  latest provider probe: oxford-current-missing-provider-probe10-4689af7 at taxicab 67187dc, 1/10 recovered, residuals 5 bot_block_403, 3 html_instead_of_pdf, and 1 js_redirect_unresolved; oxjobs d4b6da1b; partial provider evidence, not route-code candidate yet
