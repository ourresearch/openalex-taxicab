...
Gate 21.999dy: run current Sage missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 6de28ec3 #461 taxicab-pdf: publish current BMJ probe
  ...
  latest provider probe: bmj-current-missing-provider-probe10-9ccfeaf at taxicab 9ccfeaf, 2/10 recovered, residual best categories 6 bot_block_403 and 2 interstitial_or_paywall; oxjobs 6de28ec3; partial provider-strategy evidence, expand before route-code candidate
