...
Gate 21.999ea: run current Karger missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: eddf9c5a #461 taxicab-pdf: publish current AMA probe
  ...
  latest provider probe: ama-current-missing-provider-probe10-2198bc2 at taxicab 2198bc2, 0/10 recovered, best categories 5 interstitial_or_paywall, 4 js_redirect_unresolved, and 1 bot_block_403; oxjobs eddf9c5a; provider/Zyte PDF-byte, access-flow, and bot-block lane, not route-code candidate
