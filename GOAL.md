...
Gate 21.999gc: choose the next non-duplicate provider/gold/validator residual lane or wait for Zyte-advised PDF-byte recipe. [next, no Taxicab main push]
...
PDF:
  ...
  latest provider probe: degruyter-network-capture-probe3-d178c76 at taxicab d178c76 tested Zyte browser networkCapture with a broad pdf token against 3 current De Gruyter Brill /document/doi/.../pdf rows; recovered 0/3 good_pdf, all 3 as 405 text/html captcha bot blocks; provider/support evidence only
