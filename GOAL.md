...
Gate 21.999dz: run current AMA missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: d059488d #461 taxicab-pdf: publish current Sage probe
  ...
  latest provider probe: sage-current-missing-provider-probe10-1f57c9b at taxicab 1f57c9b, 0/10 recovered, best categories 6 bot_block_403 and 4 js_redirect_unresolved; oxjobs d059488d; provider/Zyte bot-block and JS-access-flow lane, not route-code candidate
