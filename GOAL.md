...
evidence. Run `residual-subclusters-after-taylor-1b303a5` found 1,481
normalized path-pattern subclusters without Taxicab API, Zyte, Browserbase, R2,
or DynamoDB writes. The next lane is to choose a fresh non-duplicate path
family from that artifact or wait for Zyte/Browserbase provider guidance before
route code.
Next exact command:
...
Gate 21.999ff: choose next non-duplicate path-family probe or wait for provider-guided recipe. [next, no Taxicab main push]
...
PDF:
  ...
  latest oxjobs publication: 106a93f8 #461 taxicab-pdf: publish route subclusters
  ...
  latest planning slice: residual-subclusters-after-taylor-1b303a5 at taxicab 1b303a5 and oxjobs 106a93f8 splits residuals into 1,481 normalized path-pattern subclusters; accepted KPI stays 2,304/6,293 good_pdf (36.61%)
