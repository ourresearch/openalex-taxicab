...
Gate 21.999ee: run current IOP missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: f57bad44 #461 taxicab-pdf: publish current Optica probe
  ...
  latest provider probe: optica-current-missing-provider-probe10-1b0823d at taxicab 1b0823d, 0/10 recovered; residual best categories 8 js_redirect_unresolved and 2 html_instead_of_pdf; browser HTML produced 8 interstitial/paywall rows; oxjobs f57bad44; provider/Zyte PDF-byte and access-flow evidence, not route-code candidate
