...
Gate 21.999dm: run current Oxford missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 40cf1b9e #461 taxicab-pdf: publish current Lippincott probe
  ...
  latest provider probe: lippincott-current-missing-provider-probe10-eb75f5e at taxicab 4689af7, 0/10 recovered, 10 download_404 and all 40 strategy attempts download_404 against LWW PageNotFound HTML; oxjobs 40cf1b9e; not route-code candidate
