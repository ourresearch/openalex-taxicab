...
```bash
cd /Users/shubh-trips/Documents/OpenAlex/openalex-taxicab && python3 scripts/provider_pdf_probe.py --input /Users/shubh-trips/Documents/OpenAlex/parseland-eval/eval/data/merged-FINAL-pdf-review-pack-top250.csv --category '' --host asmedigitalcollection.asme.org --limit 5 --strategies all --out /tmp/taxicab-pdf-review-provider-probes --run-id asme-review-pack-provider5-<taxicab-sha> --env-file .env --timeout 45 --sleep 0.5
```
