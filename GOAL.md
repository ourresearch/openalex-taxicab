...
Gate 21.999gd: test Oxford Academic token network-capture recipe on a bounded no-storage sample or wait for Zyte-advised PDF-byte recipe. [next, no Taxicab main push]
...
PDF:
  ...
  latest provider probe: lippincott-network-capture-probe3-84b519f at taxicab 84b519f tested Zyte browser networkCapture with a broad pdf token against 3 current Lippincott journals.lww.com rows; recovered 0/3 good_pdf, with 2 js_redirect_unresolved and 1 bot_block_403; provider/support evidence only
