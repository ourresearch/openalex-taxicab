...
Gate 21.999du: run current Brill missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 21a7697c #461 taxicab-pdf: publish current ACS probe
  ...
  latest provider probe: acs-current-missing-provider-probe10-7e4b5e5 at taxicab 7e4b5e5, 0/10 recovered, all best categories js_redirect_unresolved; oxjobs 21a7697c; provider/JS-access-flow lane, not route-code candidate
