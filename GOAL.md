...
Gate 21.999dw: run current SPIE missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 4838bd1c #461 taxicab-pdf: publish current Thieme probe
  ...
  latest provider probe: thieme-current-missing-provider-probe10-3f45c6a at taxicab 3f45c6a, 0/10 recovered, all best categories and all 40 strategy rows js_redirect_unresolved; oxjobs 4838bd1c; provider/Zyte JS-access-flow lane, not route-code candidate
