...
PDF:
  ...
  latest oxjobs publication: df99a77f #461 taxicab-pdf: publish prioritized subclusters
  ...
  latest planning slice: residual-subclusters-prioritized-fffb10f at taxicab fffb10f and oxjobs df99a77f adds priority bands to 1,481 normalized path-pattern subclusters; top 160 split into 105 provider-lane/do-not-duplicate, 29 Browserbase/Zyte-gold-first, 17 fresh probes, 4 existing branch candidates, 4 validator/provider lanes, 1 inspect-first; accepted KPI stays 2,304/6,293 good_pdf (36.61%)
