...
PDF:
  ...
  latest implementation candidates: 3b2d218 taxicab: fetch Wiley pdfdirect as PDF bytes; 07c8f95 taxicab: fetch IOP article PDFs as bytes; current branch ACM /doi/pdf byte route pending commit
  ...
  latest oxjobs publication: 51b4665a #461 taxicab-pdf: publish IOP all-current confirmation
