...
Gate 21.999dt: run current ACS missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: e3621c28 #461 taxicab-pdf: publish current RSC probe
  ...
  latest provider probe: rsc-current-missing-provider-probe10-f709792 at taxicab f709792, 1/10 recovered through google_referer, residual best categories 8 js_redirect_unresolved and 1 html_instead_of_pdf; oxjobs e3621c28; partial provider-strategy evidence, not route-code candidate yet
