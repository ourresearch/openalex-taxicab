...
Gate 21.999dl: run current Lippincott missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: b04396d6 #461 taxicab-pdf: publish current De Gruyter probe
  ...
  latest provider probe: degruyter-current-missing-provider-probe10-eb75f5e at taxicab eb75f5e, 0/10 recovered, 8 js_redirect_unresolved and 2 bot_block_403; browser HTML hit captcha for all 10, accept_pdf/google_referer returned empty bodies for all 10; oxjobs b04396d6; not route-code candidate
