...
Gate 21.999eb: run current APS missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 69b2780a #461 taxicab-pdf: publish current Karger probe
  ...
  latest provider probe: karger-current-missing-provider-probe10-4427b24 at taxicab 4427b24, 0/10 recovered, all best categories html_instead_of_pdf; oxjobs 69b2780a; provider/Zyte PDF-byte and access-flow lane, not route-code candidate
