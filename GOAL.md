...
Gate 21.999gb: choose the next non-duplicate provider/gold/validator residual lane or wait for Zyte-advised PDF-byte recipe. [next, no Taxicab main push]
...
PDF:
  ...
  latest provider probe: springer-network-capture-probe3b-56d2c2c at taxicab 56d2c2c tested Zyte browser networkCapture against 3 current Springer link.springer.com/content/pdf rows; recovered 0/3 good_pdf, with 2 target-site 429 rate-limit outcomes and 1 js_redirect_unresolved; provider/support evidence only
