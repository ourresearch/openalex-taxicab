...
Gate 21.999dq: run current JSTOR missing-PDF no-storage provider probe from the refreshed full gate. [next]
...
PDF:
  ...
  latest oxjobs publication: 2c171c7e #461 taxicab-pdf: publish current SSRN probe
  ...
  latest provider probe: ssrn-current-missing-provider-probe10-863d7aa at taxicab 863d7aa, 0/10 recovered, all best categories js_redirect_unresolved; accept_pdf and Google-referer returned empty responses; oxjobs 2c171c7e; provider/click-download lane, not route-code candidate
