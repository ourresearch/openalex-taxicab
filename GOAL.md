...
Current publish status: oxjobs #461 commit `bbf1da67` publishes AJOL unknown-tail recovery after the prior unknown direct-PDF slice. IJISRT/ISCA remain 5/5 durable from Taxicab `2244ccc`; AJOL at Taxicab `484606b` recovered 1/3 in no-storage, and bounded reharvest/read-only confirmation preserved 1/3 durable `good_pdf`. IET 0/3, SIAM 0/2, JoVE 0/2, AIMS 0/2, and KCI 0/2 remain provider/candidate debt.
Current phase: unknown direct-PDF/tail recovery is published as bounded durable cache lift, not accepted full-10K KPI lift. Latest accepted full-gate refresh remains `pdf-full10k-publisher-attribution-e584811` at Taxicab `8a35869`: 2,196/6,293 `good_pdf` (34.90%), 3,805 missing, 65 corrupt/truncated, 0 timeout, 0 `taxicab_error`, and a 3,783-row gap to 95%. Next lane is either another small unknown direct-PDF cluster or a full-gate confirmation batch after enough bounded recoveries accumulate. Do not push Taxicab main before the full PDF 95% proof.
Next exact command:
