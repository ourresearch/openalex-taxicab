...
Current phase: Gate 21.999ao complete; UC Press recovered 0/6 PDFs and is recorded in oxjobs at e435bc5e. Gate 21.999ap, RUPress bounded sample or provider-guidance test, is next.
...
Gate 21.999ap: run RUPress targeted sample, or test provider guidance for accumulated packets. [next]
...
PDF:
  ...
  next lane: RUPress bounded sample from latest full gate, or send/test provider packets if Zyte guidance is available
