...
cd /Users/shubh-trips/Documents/OpenAlex/openalex-taxicab
git switch codex/taxicab-pdf-phase2
rg -n '_fetch_wiley_pdfdirect|_fetch_iop_article_pdf|dl\.acm|doi/pdf' openalex_taxicab/http_cache.py tests/test_http_cache.py
```
