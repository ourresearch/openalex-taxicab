...
`pdf-full10k-after-sseditora-ac692df` is 2,402/6,293 `good_pdf`
(38.17%), +1 versus Sorbonne and +565 versus denominator baseline. It has
3,772 `missing_pdf_harvest`, 0 timeout, 0 `taxicab_error`, and 0
