...
`taxicab-pdf-after-journaluniga-cache-fc0be25` is 2,463/6,293
`good_pdf` (39.14%), +2 versus the prior accepted public TRUE cache gate and
...
2,463/2,513 (98.01%) but provisional until 3,090 REVIEW rows are resolved. The
post-JournalUniga tail-probe batch recovered 0/8; no-PDF-expected automation reduced REVIEW to 3,090 and should not be retried
