...
`pdf-full10k-after-sorbonne-26d14fc` is 2,401/6,293 `good_pdf`
(38.15%), +1 versus Taru/S3 and +564 versus denominator baseline. It has
3,773 `missing_pdf_harvest`, 0 timeout, 0 `taxicab_error`, and 0
