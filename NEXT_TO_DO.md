...
Current gate: AJConline `ajconline.org` tail sample is recorded at oxjobs b4b2a251; IATED `library.iated.org` tail sample is next.
...
choose IATED `library.iated.org` rows from
