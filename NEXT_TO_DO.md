...
Current gate: DOI-router PDF URL provider lane is recorded at oxjobs 4c711418; ScienceDirect direct PDF asset URLs are next.
...
ScienceDirect direct PDF asset URL rows from the latest full gate or test
