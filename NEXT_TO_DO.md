...
Current gate: structured PDF parser is implemented at Taxicab commit `a61d34b`; oxjobs #461 is pushed at `dcb7bb14` with the accepted structured-parser full gate, at `9569e1f6` with the Wiley residual 5-row probe, and at `6ba84787` with the Wiley residual all-row probe. Taxicab commit `3b2d218` implements the narrow Wiley PDF-byte strategy candidate. Oxjobs #461 commit `d4f99eee` publishes that candidate evidence. Oxjobs #461 commit `31d28693` publishes the Wiley/Springer follow-up probes and the no-route-code decision.
