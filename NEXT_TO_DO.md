...
`pdf-full10k-after-solen-279302d` is 2,403/6,293 `good_pdf`
(38.19%), +1 versus SS Editora and +566 versus denominator baseline. It has
3,771 `missing_pdf_harvest`, 0 timeout, 0 `taxicab_error`, and 0
