...
`pdf-full10k-after-tarupublication-6555f2c` is 2,400/6,293 `good_pdf`
(38.14%), +1 versus Tidsskrift and +563 versus denominator baseline. It has
3,774 `missing_pdf_harvest`, 0 timeout, 0 `taxicab_error`, and 0
good-to-non-good regressions. The current handoff block above is authoritative;
