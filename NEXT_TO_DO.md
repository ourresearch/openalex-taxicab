...
`69b2780a`, APS `5da73adb`, ACM `88c2fddb`, Optica `f57bad44`, and IOP `bd7396fb`.
...
cd /Users/shubh-trips/Documents/OpenAlex/openalex-taxicab
git switch codex/taxicab-pdf-phase2
rg -n "iopscience|pdfdirect|DIRECT_FETCH_URLS|BROWSER_HTML_URLS|Wiley PDF-direct" openalex_taxicab/http_cache.py tests
```
